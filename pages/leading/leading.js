        ...
        <div className={styles.container}>
           <section className={styles.header}>
            ...
            <section className={styles.acionista}>
                ...
                <div>
                    <h2>Encontra <span>acionistas</span> para seu aplicativo</h2>
...
pessoas específicas para lançar seu aplicativo para o exterior, e cehgar nas mãos de milhares de angolanos e não só.</p>
            ...
            <section className={styles.people}>
                <div>
                    <h2>Conheça <span>pessoas</span> com mais habilidades que você</h2>
            ...
            <section className={styles.moreDetails}>
                <h2>Aqui você tem opções de <span>contrato</span></h2>
                <div>
            ...
            <footer>`@bantu ${new Date().getUTCFullYear()} todos os direitos reservados`</footer>
        </div>
